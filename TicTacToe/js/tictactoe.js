...
function placeXOrO(squareNumber) {
    //This condition ensures a square hasn't been selected already. The .some() method is used to check each element of the selectSquare array to see if it contains the square number clicked on
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    animateLineDrawing();
    //This line waits 1 second. Then, cleasr canvas, resets game, and allows clicking again
